...
from espnet2.gan_tts.jets_new.alignments import (
    AlignmentModule,
    average_by_duration,
    viterbi_decode,
)
from espnet2.gan_tts.jets_new.length_regulator import GaussianUpsampling
...
class JETSGenerator(torch.nn.Module):
    ...
    def forward(
        ...
        log_p_attn = self.alignment_module(hs, feats, text_lengths, feats_lengths, h_masks)
